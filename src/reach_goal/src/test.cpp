...
string writePath = "/home/inano/ucar_ws/src/reach_goal/src/picture/";
int flag = 0;
...
int main(int argc, char** argv) {
	...
	*/
	...
	goal.target_pose.pose.orientation.z = L_orientation_z;
	goal.target_pose.pose.orientation.w = L_orientation_w;
	...
	system("python /home/inano/ucar_ws/src/reach_goal/src/predict.py");
	return 0;
}
