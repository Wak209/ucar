...
goal.target_pose.header.frame_id = "map";
	...
	goal.target_pose.pose.position.y = F_y;
	goal.target_pose.pose.orientation.z = F_orientation_z;
	goal.target_pose.pose.orientation.w = F_orientation_w;
    ...
    take_photo("E");
        goal.target_pose.header.frame_id = "map";
	goal.target_pose.header.stamp = ros::Time::now();
	goal.target_pose.pose.position.x = A_x;
	goal.target_pose.pose.position.y = A_y;
	 goal.target_pose.pose.orientation.z = A_orientation_z;
	goal.target_pose.pose.orientation.w = A_orientation_w;
	...
	goal.target_pose.pose.orientation.w = E_orientation_w;
        ROS_INFO("%f %f",E_orientation_z,E_orientation_w);
	ROS_INFO("Sending goal D");
	ac.sendGoal(goal);
	// Wait for the action to return
	ac.waitForResult();
