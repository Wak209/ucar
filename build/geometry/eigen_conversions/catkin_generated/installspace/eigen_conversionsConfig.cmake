...
if(NOT "include;/usr/include/eigen3;/opt/ros/melodic/share/orocos_kdl/cmake/../../../include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'eigen_conversions' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/inano/ucar_ws/install/${idir}'.  ${_report}")
    endif()
