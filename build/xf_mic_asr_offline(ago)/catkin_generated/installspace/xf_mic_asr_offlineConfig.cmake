...
if("FALSE" STREQUAL "TRUE")
  set(xf_mic_asr_offline_SOURCE_PREFIX /home/inano/ucar_ws/src/xf_mic_asr_offline(ago))
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'xf_mic_asr_offline' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/inano/ucar_ws/install/${idir}'.  ${_report}")
    endif()
